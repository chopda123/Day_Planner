...
// // Client for browser (with limited permissions)
...
// Client for browser (anon key). Use in client components only.
...
// Admin client for server-side operations (service role). Use on server only.
...
// Convenience default export (use carefully)
export const supabaseDefault = typeof window === 'undefined' ? createAdminClient() : createClient()
